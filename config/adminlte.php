    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'active' => ['admin/roles*', 'admin/permission*'],
            'submenu' => [
                [
                    'text'  => 'Roles',
        ...
        'Datetimepicker' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'vendor/datetimepicker/jquery.datetimepicker.full.min.js',
                ],
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => 'vendor/datetimepicker/jquery.datetimepicker.min.css',
                ],
            ]
        ],
        'Summernote' => [
