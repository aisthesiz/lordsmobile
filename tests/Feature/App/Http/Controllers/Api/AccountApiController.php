...
class AccountApiControllerTest extends TestCase
{
    ...
    public function test_get_by_id_when_account_id_is_invalid()
    {
        ...
        $response->assertJsonStructure(['message', 'exception', 'file', 'line', 'trace' => []]);
        $this->assertEquals("No query results for model [App\Models\Account] 487598579457", $response->json('message'));
